<div class="container" style="margin-top: 133px;">
    <div class="row">
        <div class="col-8" style="background: #003838;">
            <div class="description" style="margin: 15px;">
                ...
                <div class="header" style="background: #002A32;margin: 20px 0;text-align: center;">
                    Powers and Stats
                </div>
                <div>
        ...
        <div class="col-4" style="background: #544C4D; font-family: Palatino, Palatino Linotype, Palatino LT STD, Book Antiqua, Georgia, serif; font-size: 18px; font-weight: bold; color: white;">
